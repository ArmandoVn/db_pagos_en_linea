...
CREATE TABLE CURSO(
    CURSO_ID        NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_CURSO'),
...
-- TABLE: STATUS CURSO
-- 
CREATE SEQUENCE IF NOT EXISTS SEQ_ESTARTUS_CURSO;

CREATE TABLE ESTATUS_CURSO(
    ESTATUS_CURSO_ID     NUMERIC(3,0)   DEFAULT NEXTVAL('SEQ_ESTARTUS_CURSO'),
    NOMBRE              VARCHAR(30)     NOT NULL,
    DESCRIPCION         VARCHAR(200)    NOT NULL,

    CONSTRAINT ESTATUS_CURSO_PK PRIMARY KEY (ESTATUS_CURSO_ID)
);
...
CREATE TABLE FACTURA(
    FACTURA_ID      NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_FACTURA'),
...
CREATE TABLE FICHA_REFERENCIA(
    FICHA_REFERENCIA_ID NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_FICHA_REFERENCIA'),
...
CREATE TABLE FORMA_PAGO(
    FORMA_PAGO_ID   NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_FORMA_PAGO'),
...
CREATE TABLE PERFIL_USUARIO(
    PERFIL_USUARIO_ID   NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_PERFIL_USUARIO'),
    PERFIL_USUARIO      VARCHAR(40)     NOT NULL,
    DESCRIPCION         VARCHAR(200)    NOT NULL,
    PORCIENTO_DESCUENTO NUMERIC(3,2)    NOT NULL,
...
CREATE TABLE TIPO_USUARIO(
    TIPO_USUARIO_ID     NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_TIPO_USUARIO'),
...
CREATE TABLE USUARIO(
    USUARIO_ID          NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_USUARIO'),
    NOMBRE              VARCHAR(40)     NOT NULL,
...
CREATE TABLE HISTORICO_CURSO(
    HISTORICO_CURSO_ID  NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_HISTORICO_CURSO'),
    FECHA_ESTATUS       DATE            NOT NULL,
    ESTATUS_CURSO_ID    NUMERIC(5,0)    NOT NULL,
...
CREATE TABLE CURSO_USUARIO(
    CURSO_USUARIO_ID    NUMERIC(5,0)    DEFAULT NEXTVAL('SEQ_CURSO_USUARIO'),
    FECHA_ESTATUS_ACTUAL    DATE        NOT NULL,
    CURSO_ID            NUMERIC(5,0)    NOT NULL,
    USUARIO_ID          NUMERIC(5,0)    NOT NULL,
    ESTATUS_CURSO_ID    NUMERIC(5,0)    NOT NULL,
...
ALTER TABLE HISTORICO_CURSO
    ADD CONSTRAINT ESTATUS_CURSO_FK FOREIGN KEY (ESTATUS_CURSO_ID)
    REFERENCES ESTATUS_CURSO (ESTATUS_CURSO_ID);
